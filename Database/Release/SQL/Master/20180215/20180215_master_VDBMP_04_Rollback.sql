...
-- Path: /Database/Release/SQL/Master/20180215/20180215_master_VDBMP_04_Rollback.sql
...
--=====MANIFEST===================================================================================
--   DS-0215.01.Drop.Beat.Rollback.sql

--=====PATCHES====================================================================================

--================================================================================================
-- /Database/Release/SQL/Patch/20180215/VDBMP/DS-0215.01.Drop.Beat.Rollback.sql
PRINT 'Processing DS-0215.01.Drop.Beat.Rollback.sql ******** Start'
GO
SET ANSI_NULLS ON;
GO
SET ANSI_PADDING ON;
...
PRINT 'Line1 rollback';
GO
;
GO
PRINT 'Processing DS-0215.01.Drop.Beat.Rollback.sql ******** End'
GO
...
INSERT INTO dbo.dbverinfo (BuildConfigId, BuildKey, EventNote, MasterType, EventDate)
	VALUES (15, '2fbdef46-ef10-4532-879c-a6a64de91ab3', '20180215 VDBMP', 'Rollback', GETDATE());
GO
